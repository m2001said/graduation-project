                  ...
                  <SwiperSlide key={index}>
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                      ...
                      <div className="hero14-textContent flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10 ">
                        <h1 className="text-2xl sm:text-6xl lg:text-2xl font-bold text-black dark:text-white">{data.subtitle}</h1>
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-black dark:text-white">{data.title}</h1>
