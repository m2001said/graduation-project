...
//           <p className="text-[#808080] lg:text:base text-sm lg:w-3/5">asda asd dadc dad</p>
//         </div>

//         <div className="flex gap-x-4 lg:w-2/5 lg:pt-0 pt-6">
//           <button className="text-[#0ca39a] rounded-full border border-[#0ca39a] hover:text-white focus:bg-[#0ca39a] focus:text-white">ALL</button>
//           <button className="text-[#0ca39a] rounded-full border border-[#0ca39a] hover:text-white focus:bg-[#0ca39a] focus:text-white">SELL</button>
//           <button className="text-[#0ca39a] rounded-full border border-[#0ca39a] hover:text-white focus:bg-[#0ca39a] focus:text-white">RENT</button>
//         </div>
//       </div>
...
//                 <button
//                   className={`px-5 py-2 flex gap-x-2 items-center text-[${card.buttonColor}] bg-[${card.buttonBgColor}] rounded-full absolute bottom-10 left-10`}
//                 >
//                   <img src={card.icon} alt={card.features[0].text} className="w-6 h-6" />
