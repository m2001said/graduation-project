...
const Services15 = () => {
  const { serv15 } = useSelector((state) => state.template15);
    ...
    return (
      <div className="w-full hoverBtn">
        <div className="title15_4 rounded-[18px] py-[20px] px-10 relative overflow-hidden">
          ...
          <a href="#pricing" className="font-bold flex items-center gap-x-2 no-underline  ml-20 title15_7">
            {serv15[0].btn15.btn15_Text}
            <img src={serv15[0].imgUrl.input} alt="" style={{ width: "30px", height: "30px" }} />
          </a>
  ...
  return (
    <div className="pt-52 backgroundcolor darkModeColor px-3" id="services">
      <div className="container max-w-[1300px] w-full mx-auto">
        <h1 className="sm:text-[44px] text-[26px] text-center m-0 title15_1">{serv15[0].title.t1}</h1>
        <p className="font-bold text-sm textColor flex items-center text-center justify-center gap-x-4 title15_2">
          {serv15[0].title.t2}
          <span className="caveat text-3xl title15_3">{serv15[0].title.t3}</span>
        </p>

        <section className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10 mt-8 w-full ">
          <Card title={serv15[0].Card1.title} sub_title={serv15[0].Card1.sub_title} text={serv15[0].Card1.text} />
          <Card title={serv15[0].Card2.title} sub_title={serv15[0].Card2.sub_title} text={serv15[0].Card2.text} />
          <Card title={serv15[0].Card3.title} sub_title={serv15[0].Card3.sub_title} text={serv15[0].Card3.text} />
        </section>
      </div>
    </div>
  );
