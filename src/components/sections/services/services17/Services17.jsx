  ...
  return (
    ...
    >
      <div className="container17">
        <h1 className="pb-16 tracking-wider text-8xl ephesis font-semibold text-[var(--website-17-color-2)] text-center">
          {services.title}
        </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-14 sm:gap-4">
          {services.services.map((item, index) => (
            ...
            >
              <p className="text-[var(--website-17-color-2)] text-2xl p17">
                {item.description}
              </p>
              <p className="text-5xl rotate-90 text-[var(--website-17-color-2)] text-center translate-x-5">
                .....
              </p>
              <img
                src={item.icon}
                alt={`Service ${index + 1}`}
                className={`text-5xl text-[var(--website-17-color-4)] w-1/4 ${
                  index === 0 && isHovered ? "walkToEnd" : ""
