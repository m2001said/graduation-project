...
//   return (
//     <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`} style={{ color: "var(--website-7-color-4)" }}>
...
//               <h4 className="font-poppins font-medium text-[18px] leading-[27px] text-[var(--website-7-color-4)]">{section.title}</h4>
