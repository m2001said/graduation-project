  ...
  return (
    <div className='footer1'>
        <div className="footer1-icons">
            <h1><img src={logo} alt="" className='footer1-img' /> Interno </h1>
            <p>It is a long established fact that a reader will be distracted lookings.</p>
          <div className='footer1-media-icon'>
            <a href=' '><img src={FaceBook} alt="" className='footer1-img' /></a> 
            <a href=' '><img src={Twitter} alt="" className='footer1-img'/></a>
            <a href=' '><img src={LinkedIn} alt="" className='footer1-img'/></a>
            <a href=' '><img src={Inestagram} alt="" className='footer1-img'/></a>
          </div>
        </div>
