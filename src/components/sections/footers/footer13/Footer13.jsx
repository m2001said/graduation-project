          ...
          <div className="lg:py-20">
            ...
            <ul className="lg:flex items-center justify-between lg:pt-8">
              ...
              <span className="text-[var(--white-13)] lg:w-1/3 justify-center flex items-center gap-4">
                <img src={footer.facebook} className="cursor-pointer rounded-full border border-[#154b3b] p-2 h-8 w-8" />
                <img src={footer.instagram} className="cursor-pointer rounded-full border border-[#154b3b] p-2 h-8 w-8" />
                <img src={footer.facebook} className="cursor-pointer rounded-full border border-[#154b3b] p-2 h-8 w-8" />
                <img src={footer.linked} className="cursor-pointer rounded-full border border-[#154b3b] p-2 h-8 w-8" />
                <img src={footer.twitter} className="cursor-pointer rounded-full border border-[#154b3b] p-2 h-8 w-8" />
              </span>
            </ul>
          </div>
        </section>
