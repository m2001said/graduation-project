...
const Cta15 = () => {
  ...
  return (
    <main className="flex flex-col items-center justify-center w-full min-h-screen cta15" id="resume">
      <h1 className="sm:text-[44px] text-[26px] text-center m-0 cta15_1">{cta.titles.title}</h1>
      <p className="font-bold text-sm flex items-center justify-center gap-x-4 cta15_2">{cta.titles.sub_title}</p>
