    ...
    return (
      <div className="hoverBtn ">
        <div className="proj15_5 rounded-[20px] py-[30px] px-[35px] relative overflow-hidden ">
          ...
          <a href="#project" className="font-bold flex items-center gap-x-2 no-underline text-[var(--website-15-color-2)] hover:text-[var(--website-15-color-5)] ">
    ...
    <main className="pb-5 pt-52 px-3 proj15 " id="works">
      <div className="flex flex-col items-center container max-w-[1300px] mx-auto">
        ...
        <span className="block rounded-full mt-[70px] h-14 border-black border-solid shadowbtn">
          <button className="bg-transparent  h-full font-bold px-10 rounded-full hover:border-2 border-solid bg-[var(--website-15-color-5)] text-[var(--website-15-color-1)] hover:border-white proj15_10">
