    ...
    <div>
      <div className="container14">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto space-y-2">
          <h1 className="text-3xl font-bold lg:text-4xl">{projects14_1.title}</h1>
          <p className="text-xs text-gray-400">{projects14_1.description}</p>
        </div>
        {/* Body section */}
        <div className="mb-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 place-items-center">
            {/* card section */}
            {projects14_1.cards.map((data, index) => (
