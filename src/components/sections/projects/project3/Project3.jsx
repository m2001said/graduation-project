    ...
    <div className="Project3" id="Programs">
      <div className="Project3-header">
        {template.projects.title &&
          template.projects.title.map((item, index) => (
            <span key={index} className={index % 2 === 0 ? "stroke-text" : ""}>
              {item.Subtitle}
            </span>
          ))}
      ...
      <div className="project3-categories">
        {template.projects.descriptions &&
          template.projects.descriptions.map((program, index) => (
            <div className="category" key={index}>
              <span>{program.heading}</span>
              <span>{program.details}</span>
              <div className="join-now">
                <span>{template.projects.actionButton}</span>
