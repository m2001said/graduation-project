    ...
    <div id="about13" className="relative overflow-hidden bg-[var(--c616161)] lg:py-20 py-8">
      ...
      <div className="xl:w-[1200px] mx-auto px-3 pt-8">
        <section className="relative">
          <p className="text-center text-[var(--color-13-yel)]">{about1.title}</p>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 pt-8">
            <span className="bg-[var(--c616161)] py-8 px-6 hover:bg-[var(--[white]-13)] hover:text-[var(--color-13-yel)]">
              ...
              <p className="text-[var(--color-darkG-13)]">{about1.icon1description}</p>
            </span>{" "}
            <span className="bg-[var(--c616161)] py-8 px-6 hover:bg-[var(--white-13)] hover:text-[var(--color-13-yel)]">
              ...
              <p className="text-[var(--color-darkG-13)]">{about1.icon2description}</p>
            </span>{" "}
            <span className="bg-[var(--c616161)] py-8 px-6 hover:bg-[var(--white-13)] hover:text-[var(--color-13-yel)]">
              ...
              <p className="text-[var(--color-darkG-13)]">{about1.icon3description}</p>
            </span>{" "}
            <span className="bg-[var(--c616161)] py-8 px-6 hover:bg-[var(--white-13)] hover:text-[var(--color-13-yel)]">
              ...
              <p className="text-[var(--color-darkG-13)]">{about1.icon4description}</p>
            </span>{" "}
          </div>
        </section>
        <section className="lg: flex justify-between items-center relative mt-12 lg:p-8">
          ...
          <div className="lg:w-1/2 lg:py-0 py-20">
            <p className="text-[var(--color-13-yel)]">{about2.title}</p>
            ...
            <p className="text-[var(--color-darkG-13)] leading-8">{about2.subtitle}</p>
          ...
          <img src={about2.arrow} className="text-[var(--color-13-yel)] text-4xl absolute top-0  left-0 rotate-[315deg] w-10" />
          <img src={about2.arrow} className="text-[var(--color-13-yel)] text-4xl absolute top-0  left-0 rotate-[315deg] w-10" />
          <img src={about2.arrow} className="text-[var(--color-13-yel)] text-4xl absolute top-0  left-0 rotate-[315deg] w-10" />
          <img src={about2.arrow} className="text-[var(--color-13-yel)] text-4xl absolute top-0  left-0 rotate-[315deg] w-10" />
        </section>
