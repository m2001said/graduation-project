      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 pt-8">
        {features &&
          features.map((feature, index) => (
            <span key={index} className="bg-[var(--website-13-color-6)] py-8 px-6 hover:bg-[var(--website-13-color-3)] hover:text-[var(--website-13-color-4)]">
              <img src={feature.icon} className="w-10 text-5xl hover:bg-[var(--website-13-color-4)]" alt={feature.title} />
