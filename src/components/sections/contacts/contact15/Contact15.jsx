...
//   const ContactInfo = ({ title, subtitle, imgUrl }) => {
//     return (
...
//           <p className="cont15_8 m-0 ">{subtitle}</p>
//         </span>
//       </div>
//     );
//   };
...
//                 <ContactInfo key={index} title={item.title} subtitle={item.subtitle} imgUrl={item.imgUrl} />
//               ))}
//             </div>
//           </section>
