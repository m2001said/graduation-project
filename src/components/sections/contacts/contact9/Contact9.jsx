...
const Contact9 =  ({ template }) => {
  ...
  const renderImage = contact.imgUrl ? <img src={contact.imgUrl} alt="" className="h-15 w-60 sm:h-27 sm:w-24 lg:h-40 lg:w-40 mr-40 img-9 hover:translate-x-8 hover:-translate-y-8 transition-transform duration-500 " /> : null;
