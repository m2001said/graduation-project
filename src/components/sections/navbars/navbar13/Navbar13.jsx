    ...
    <nav className=" z-50 bg-[var(--website-13-color-2)] nav13">
      <div className="container mx-auto lg:flex flex-wrap items-center justify-between px-3 border-b border-[var(--website-13-color-22)]">
        ...
        <div className={`lg:flex flex-grow lg:items-center items-baseline lg:h-auto justify-center lg:w-4/5 ${isOpen ? "block" : "hidden"}`}>
          <ul
            className={`flex flex-col lg:flex-row items-center justify-between w-full gap-x-4 list-none lg:ml-auto lg:transform-none lg:translate-y-[-50%] ${
              direction === "rtl" ? "rtl" : ""
            }`}
          >
            ...
            <li>
              <button
                className={`rounded-full px-1 flex items-center bg-[var(--website-13-color-4)] text-[var(--website-13-color-2)] gap-1 transition ease-out duration-300 transform hover:scale-110 py-auto contact-button13 ${
                  direction === "rtl" ? "rtl" : ""
                }`}
              >
