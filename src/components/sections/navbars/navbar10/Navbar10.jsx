...
const Navbar10 = ({template}) => {
  ...
  return (
    <>
      <div className="shadow-lg bg-[--website-10-color-2] dark:bg-gray-900 dark:text-white duration-200 ">
        <div className="items-center p-10 sm:p-30 py-3 sm:py-0">
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center gap-4">
              ...
              {/* <button className="btnBg10 btnTxt10 hover:scale-105 duration-200 py-1 px-4 rounded-full flex items-center gap-3">
                {navbar.buttonText}
                <a href=" ">
