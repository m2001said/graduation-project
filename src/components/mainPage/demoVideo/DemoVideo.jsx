      ...
      <div className="demo-section bg-gradient-to-r from-[#481b91] to-[#240d55]">
        <div className="container mx-auto text-center px-4 py-4">
          <div className="text-info">
            <h1 data-aos="fade-up" data-aos-duration="1000" className="text-3xl font-bold tracking-tighter text-white sm:text-4xl md:text-5xl lg:text-6xl/none">How to Use Our Website</h1>
            <p data-aos="fade-up" data-aos-duration="1000" className="mx-auto max-w-[700px] text-gray-200 md:text-xl ">
