        ...
        <div className="container mx-auto px-4 flex  justify-between items-center py-4">
          ...
          <div className="nav-controls flex justify-between items-center gap-4 md:gap-6">
            ...
            <LoadingButton
              ...
              onClick={authState.status === "succeeded" && authState.userName ? handleSignOut : toggleModal}
              className="hidden md:block signIn-btn p-1 md:p-2"
              btnText={authState.status === "succeeded" && authState.userName ? t("USER.LOG_OUT") : t("USER.SIGN_IN")}
            />
