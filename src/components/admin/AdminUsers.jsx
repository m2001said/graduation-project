                  ...
                  {pages &&
                    pages?.pages?.map((page) => (
                      <div key={page._id}>
                        ...
                        <Link to={`/${language}/admin-user-page/${user._id}/${page._id}`}>Preview this page</Link>
                        <button onClick={() => deletePage(user?._id, page?._id)}>Delete this page</button>
                        <button onClick={() => setShowPages(false)}>Show less</button>
                      </div>
                    ))}
                  {}
                  {pages && pages?.pages?.length > 0 && <button onClick={() => deletePages(user?._id)}>Delete All Pages</button>}
