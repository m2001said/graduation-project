  ...
  return (
    <>
      <div className="flex flex-col md:flex-row my-4 justify-between gap-4 items-center w-full md:w-1/2 mx-auto">
        <div style={{ overflow: "hidden", maxWidth: "300px" }} className="rounded h-full">
          <img className="h-full" src={uploadedImage || userAvatar || "https://avatars.githubusercontent.com/u/127410127?v=4"} alt="Uploaded" />
        </div>
